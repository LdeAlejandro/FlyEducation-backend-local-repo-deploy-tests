...
public class UserServiceImpl implements UserService {
    ...
    public ResponseEntity<Map<String, Object>> cadastrarAluno(CadastroAluno dados) {
        ...
        Aluno aluno = Aluno.builder()
                ...
                .perfiles(Set.of(usuarioPerfil)) // herdado de UsuarioBase
                .nome(dados.nome())
                .email(dados.email())
    ...
    //Get Aluno pelo email
    @PreAuthorize("hasAuthority('SCOPE_ADMIN')")
    @Override
    public ResponseEntity<Map<String, Object>> obterAlunoByEmail(String email) {
        Optional<ObterAluno> alunoDB = alunoRepository.findByEmailContaining(email).map(ObterAluno::new);
